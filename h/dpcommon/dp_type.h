...
namespace Dp {
  ...
  namespace Math {
    ...
    inline Eigen::Matrix3d rpy2mat3 (Vector3d rpy) {
  
      //Eigen::AngleAxisd rollAngle(roll, Vector3d::UnitZ());
      //Eigen::AngleAxisd yawAngle(yaw, Vector3d::UnitY());
      //Eigen::AngleAxisd pitchAngle(pitch, Vector3d::UnitX());
      //
      //Eigen::Quaternion<double> q = rollAngle * yawAngle * pitchAngle;
      //
      //Eigen::Matrix3d rotationMatrix = q.matrix();
      
      auto rangle = Eigen::AngleAxisd(rpy(0), Vector3d::UnitX());
      auto pangle = Eigen::AngleAxisd(rpy(1), Vector3d::UnitY());
      auto yangle = Eigen::AngleAxisd(rpy(2), Vector3d::UnitZ());
  ...
  namespace Phyx {
    ...
    inline Eigen::Matrix3d pInertia (Dp::Math::real mass, Vector3d &radius) {
